"""Regression checks for the binary-net-http-mesh casebook."""
...
from casebook.harness import assert_expected, binary_net_http_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(binary_net_http_mesh_summary(), assert_expected())
